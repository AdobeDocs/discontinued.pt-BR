...
**Em 19 de agosto de 2021**, a Adobe descontinuou as integrações do Data Connectors e as substituiu pelo [Adobe Exchange Marketplace](https://exchange.adobe.com/apps/browse/ec?listingType=applications&page=1&partnerLevel=All&product=ANLYTC&sort=RELEVANCE). A Adobe pretende tornar a transição o mais simples possível para clientes e parceiros.
...
Este recurso era alimentado por tecnologia herdada que não é mais viável ou compatível. O [Adobe Exchange Marketplace](https://exchange.adobe.com/apps/browse/ec?listingType=applications&page=1&partnerLevel=All&product=ANLYTC&sort=RELEVANCE) agora é o local para encontrar integrações atualizadas para soluções Adobe.
