...
O [!DNL Adobe Experience Platform Auditor] foi um sistema que permitiu gerar relatórios que avaliam sua implementação do [!DNL Adobe Experience Cloud] e fornecem indicações sobre como melhorá-la. [!DNL Adobe Experience Platform Auditor] chegou ao fim da vida útil (EOL) e não está mais ativo.
