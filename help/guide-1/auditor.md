...
O [!DNL Adobe Experience Platform Auditor] era um sistema que permitia gerar relatórios que avaliavam sua implementação do CX Enterprise e forneciam indicações sobre como melhorá-la. O [!DNL Adobe Experience Platform Auditor] chegou ao fim da vida útil (EOL) e não está mais ativo.
